import unittest
import pandas as pd
from SampleTask.main.reportingSheetGeneration import populate_excelFile


class ReportingSheetGenerationTest(unittest.TestCase):
    ...
    def test_PopulateExcelFile_WithValidInput_ProducesCorrectOutput(self):
        ...
        input_Template_Path = '/Users/nsuhani/PycharmProjects/pythonProject/' \
                              'SampleTask/unitTest/testInputFile/reportingSheetGeneration_Test.xlsx'

        output_Path = '/Users/nsuhani/PycharmProjects/pythonProject/' \
                      'SampleTask/unitTest/testOutputFile/reportingTestOutput_validInputs.xlsx'
    ...
    def test_PopulateExcelFile_WithInvalidInputs_generatesException(self):
        ...
        output_Path = '/Users/nsuhani/PycharmProjects/pythonProject/' \
                      'SampleTask/unitTest/testOutputFile/reportingTestOutput_invalidInputs.xlsx'
