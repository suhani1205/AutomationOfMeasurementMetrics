import unittest
import pandas as pd
from SampleTask.main.scoringSheetGeneration import populate_excelFile


class scoringSheetGenerationTest(unittest.TestCase):
    ...
    def test_PopulateExcelFile_WithValidInput_ProducesCorrectOutput(self):
        ...
        input_Template_Path = '/Users/nsuhani/PycharmProjects/pythonProject/' \
                              'SampleTask/unitTest/testInputFile/scoringSheetGeneration_Test.xlsx'

        output_Path = '/Users/nsuhani/PycharmProjects/pythonProject/' \
                      'SampleTask/unitTest/testOutputFile/scoringTestOutput_validInputs.xlsx'
        ...
        assert row_data_frame['jobGroup'].values[0] == 'hvaEventsScoring_v1_backfill'
    ...
    def test_PopulateExcelFile_WithInvalidInputs_generatesException(self):
        ...
        output_Path = '/Users/nsuhani/PycharmProjects/pythonProject/' \
                      'SampleTask/unitTest/testOutputFile/scoringTestOutput_invalidInputs.xlsx'
